...
10. Написаны интеграционные тесты на валидацию входных данных и юнит-тесты на результат применения модели к данным.
11. Для моделей DTO использовался Pydantic. Для обеспечения гарантии переданных типов и удобства работы.
