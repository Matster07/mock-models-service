...
5. Для контроля над ошибками реализован глобальный обработчик ошибок, благодаря чему клиенты, использующие сервис, могут обрабатывать полученные ошибки. Также упрощается процесс поиска ошибок, работа приложения становится более контролируемой.
